...
void S3_ex6_reflection::onPluginLoad()
{
	GLWidget & g = *glwidget();
    g.makeCurrent();
    // Carregar shader, compile & link
    vs = new QOpenGLShader(QOpenGLShader::Vertex, this);
    vs->compileSourceFile(g.getPluginPath()+"/../reflection/reflect.vert");

    fs = new QOpenGLShader(QOpenGLShader::Fragment, this);
    fs->compileSourceFile(g.getPluginPath()+"/../reflection/reflect.frag");
...
void S3_ex6_reflection::drawQuad(const Point& p0, const Point& p1, const Point& p2, const Point& p3)
{
...
bool S3_ex6_reflection::paintGL()
{
	GLWidget & g = *glwidget();
	g.makeCurrent();
