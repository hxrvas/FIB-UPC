...
#define INIT_PLAYER2_X_TILES 17
...
void Scene::init()
{
	...
	//enemic
	enemic = new Enemic();
	string ene = "images/EnemySprites.png";
	enemic->init(glm::ivec2(SCREEN_X, SCREEN_Y), texProgram, ene);
	enemic->setPosition(glm::vec2(INIT_PLAYER_X_TILES * map->getTileSize() + 10*16, 1*16 + INIT_PLAYER_Y_TILES * map->getTileSize()));
	enemic->setPlayer(player);
	...
	cactus3 = new Cactus();
	cactus3->init(glm::ivec2(18 * 16, 12 * 16), texProgram, cactusP);
	cactus4 = new Cactus();
	cactus4->init(glm::ivec2(18 * 16, 17 * 16), texProgram, cactusPI);
	cactus5 = new Cactus();
	cactus5->init(glm::ivec2(23 * 16, 12 * 16), texProgram, cactusP);
	cactus6 = new Cactus();
	cactus6->init(glm::ivec2(23 * 16, 17 * 16), texProgram, cactusPI);
	cactus7 = new Cactus();
	cactus7->init(glm::ivec2(30 * 16, 12 * 16), texProgram, cactusP);
	cactus8 = new Cactus();
	cactus8->init(glm::ivec2(30 * 16, 17 * 16), texProgram, cactusPI);
	cactus9 = new Cactus();
	cactus9->init(glm::ivec2(30 * 16, 24 * 16), texProgram, cactusBI);
	cactus10 = new Cactus();
	cactus10->init(glm::ivec2(31 * 16, 12 * 16), texProgram, cactusB);
	cactus11 = new Cactus();
	cactus11->init(glm::ivec2(31 * 16, 17 * 16), texProgram, cactusBI);
	cactus12 = new Cactus();
	cactus12->init(glm::ivec2(33 * 16, 6 * 16), texProgram, cactusP);
	cactus13 = new Cactus();
	cactus13->init(glm::ivec2(34 * 16, 6 * 16), texProgram, cactusB);
	cactus14 = new Cactus();
	cactus14->init(glm::ivec2(38 * 16, 12 * 16), texProgram, cactusP);
	cactus15 = new Cactus();
	cactus15->init(glm::ivec2(38 * 16, 17 * 16), texProgram, cactusPI);
	cactus16 = new Cactus();
	cactus16->init(glm::ivec2(44 * 16, 5 * 16), texProgram, cactusB);
	cactus17 = new Cactus();
	cactus17->init(glm::ivec2(44 * 16, 17 * 16), texProgram, cactusBI);



	//cactuspincho
	string cactusf1 = "images/Obstaclecactus.png";
	string cactusf2 = "images/ObstaclecactusInverted.png";
	cactusp1 = new CactusPincho();
	cactusp1->init(glm::ivec2(33 * 16, 9 * 16), texProgram, cactusf1);
	cactusp2 = new CactusPincho();
	cactusp2->init(glm::ivec2(35 * 16, 9 * 16), texProgram, cactusf1);
	cactusp3 = new CactusPincho();
	cactusp3->init(glm::ivec2(37 * 16, 9 * 16), texProgram, cactusf1);
	cactusp4 = new CactusPincho();
	cactusp4->init(glm::ivec2(38 * 16, 4 * 16), texProgram, cactusf2);
	cactusp5 = new CactusPincho();
	cactusp5->init(glm::ivec2(40 * 16, 4 * 16), texProgram, cactusf2);

	//creem bandera
	bandera = new Bandera();
	bandera->setId(1);
	bandera->init(glm::ivec2(39 * 16, 9 * 16), texProgram, "images/Bandera.png");
	bandera->setPlayer(player);
	bandera->setPlayer2(player2);

	bandera2 = new Bandera();
	bandera2->setId(2);
	bandera2->init(glm::ivec2(39 * 16, 17 * 16), texProgram, "images/BanderaInverted.png");
	...
	palmera1->init(glm::ivec2(20 * 16, 8*16), texProgram, fileB);

	palmera2 = new Palmera();
	palmera2->init(glm::ivec2(20 * 16, 17 * 16), texProgram, fileBI);

	palmera3 = new Palmera();
	palmera3->init(glm::ivec2(44 * 16, 1 * 16), texProgram, fileB);

	palmera4 = new Palmera();
	palmera4->init(glm::ivec2(44 * 16, 17 * 16), texProgram, fileBI);

	palmera5 = new Palmera();
	palmera5->init(glm::ivec2(17 * 16, 8 * 16), texProgram, fileS);

	palmera6 = new Palmera();
	palmera6->init(glm::ivec2(17 * 16, 17 * 16), texProgram, fileSI);
